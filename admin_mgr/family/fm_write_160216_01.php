...
function regi( v_cmd ){
	...
	if(v_cmd == "del"){
		...
		if(fm.fm_img_ceo_mb.value == "" && fm.db_fm_img_ceo_mb.value == ""){
			alert("대표이사 사진(Mobile)을 선택해주세요.");
			fm.fm_img_ceo_mb.focus();
			return;
		}
		if(fm.fm_img_ceo_mb.value != ""){
			var result = upload_file_check( "image", fm.fm_img_ceo_mb.value);
			if(result != "Y"){
				alert( result );
				fm.fm_img_ceo_mb.focus();
				return;
		...
		if(fm.fm_ci_img_mb.value == "" && fm.db_fm_ci_img_mb.value == ""){
			alert("CI/BI 이미지(Mobile)를 선택해주세요.");
			fm.fm_ci_img_mb.focus();
			return;
		}
		if(fm.fm_ci_img_mb.value != ""){
			var result = upload_file_check( "image", fm.fm_ci_img_mb.value);
			if(result != "Y"){
				alert( result );
				fm.fm_ci_img_mb.focus();
				return;
		...
		if(fm.fm_logo_img_mb.value == "" && fm.db_fm_logo_img_mb.value == ""){
			alert("로고 이미지(Mobile)를 선택해주세요.");
			fm.fm_logo_img_mb.focus();
			return;
		}
		if(fm.fm_logo_img_mb.value != ""){
			var result = upload_file_check( "image", fm.fm_logo_img_mb.value);
			if(result != "Y"){
				alert( result );
				fm.fm_logo_img_mb.focus();
				return;
					...
					<tr>
						...
						<td class="text_left" style="padding-left:5px" colspan="3">
							...
							<tr>
								<th class="mu">Mobile</th>
								<td class="text_left" style="padding-left:5px">
									<input type="hidden" name="db_fm_img_ceo_mb" id="db_fm_img_ceo_mb" value="<?= $db_fm[fm_img_ceo_mb] ?>">
									<input type="file" name="fm_img_ceo_mb" id="fm_img_ceo_mb" value="" style="width:150px">
									<?
									if($db_fm[fm_img_ceo_mb] != ""){
									?>
										<a href="<?= $GLB_UP_FILE_URL.$db_fm[fm_img_ceo_mb] ?>" target="_blank"><img src="<?= $GLB_UP_FILE_URL.$db_fm[fm_img_ceo_mb] ?>" height="50"></a>
									<?
									}
									?>
								</td>
					...
					<tr>
						...
						<td class="text_left" style="padding-left:5px" colspan="3">
							...
							<tr>
								<th class="mu">Mobile</th>
								<td class="text_left" style="padding-left:5px">
									<input type="hidden" name="db_fm_ci_img_mb" id="db_fm_ci_img_mb" value="<?= $db_fm[fm_ci_img_mb] ?>">
									<input type="file" name="fm_ci_img_mb" id="fm_ci_img_mb" value="" style="width:150px">
									<?
									if($db_fm[fm_ci_img_mb] != ""){
									?>
										<a href="<?= $GLB_UP_FILE_URL.$db_fm[fm_ci_img_mb] ?>" target="_blank"><img src="<?= $GLB_UP_FILE_URL.$db_fm[fm_ci_img_mb] ?>" height="50"></a>
									<?
									}
									?>
								</td>
					...
					<tr>
						...
						<td class="text_left" style="padding-left:5px" colspan="3">
							...
							<tr>
								<th class="mu">Mobile</th>
								<td class="text_left" style="padding-left:5px">
									<input type="hidden" name="db_fm_logo_img_mb" id="db_fm_logo_img_mb" value="<?= $db_fm[fm_logo_img_mb] ?>">
									<input type="file" name="fm_logo_img_mb" id="fm_logo_img_mb" value="" style="width:150px">
									<?
									if($db_fm[fm_logo_img_mb] != ""){
									?>
										<a href="<?= $GLB_UP_FILE_URL.$db_fm[fm_logo_img_mb] ?>" target="_blank"><img src="<?= $GLB_UP_FILE_URL.$db_fm[fm_logo_img_mb] ?>" height="50"></a>
									<?
									}
									?>
								</td>
